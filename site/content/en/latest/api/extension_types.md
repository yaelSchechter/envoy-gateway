...
| `perConnectionBufferLimitBytes` | _integer_ |  false  | PerConnectionBufferLimitBytes sets a soft limit on size of the listener’s new connection read and write buffers. Default: 32768. |
